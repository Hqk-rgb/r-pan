package com.whf.pan.lock.core.aspect;
...
public class LockAspect implements ApplicationContextAware {
    ...
    @Pointcut(value = "@annotation(com.whf.pan.lock.core.annotation.Lock)")
    ...
    public Object aroundLock(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        try {
            ...
            throw new FrameworkException("aroundLock tryLock fail.");
        } catch (Throwable e) {
            log.error("lock aspect tryLock exception.", e);
            throw new FrameworkException("aroundLock tryLock fail.");
        } finally {
